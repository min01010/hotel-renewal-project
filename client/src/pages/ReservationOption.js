    ...
    <Container>
      ...
      <ReservationOptionDiv>
        <RoomInfoDiv>
          ...
          <UserInfoDiv>
            ...
            {/* <InfoText>이름 {userData.name || "불러오는 중..."}</InfoText>
            <InfoText>이메일 {userData.email || "불러오는 중..."}</InfoText>
            <InfoText>연락처 {userData.phone || "불러오는 중..."}</InfoText> */}
          </UserInfoDiv>
        ...
        <DatePriceInfoDiv>
          ...
          <ReservationButton onClick={handlePopupOpen}>예약하기</ReservationButton>
        </DatePriceInfoDiv>
      </ReservationOptionDiv>
      ...
      {popupData && (
        <PopupForm 
          ...
          {...(popupData.reservation && {
          onAccept: handleReservationConfirm,
